...
function projects() {
  var output = '<br>';
  output +=
    'see projects on <a href="https://github.com/RahulSinghParmar?tab=repositories" target="_blank" rel="noopener">GitHub</a>.';
  return output;
}
...
function contact() {
  var output = '<br>';
  output += 'Contact:<br>';
  output += 'Email: rahulsinghparmar4@gmail.com';
  return output;
}
...
function about() {
  ...
  output += 'Occupation: JAVA Software Developer';
  return output;
}
